/// <summary>
/// OuterWallsTrigger.cs
/// trigger an event in another script when the OuterWalls button is pressed on the Haus clipboard
/// </summary>
...
namespace com.jonrummery.edison {
    ...
    public class OuterWallsTrigger : MonoBehaviour {
        ...
        private void OnTriggerEnter(Collider other) {
            ...
            if ((other.tag == "bingo") &&
                ...
                //do something
                handoverScript.OuterWallsTrigger();
            }
        }
