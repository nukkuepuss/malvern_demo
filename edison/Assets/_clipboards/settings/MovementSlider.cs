/// <summary>
/// MovementSlider.cs
/// Move a slider when triggered to change the movement speed
/// </summary>
    ...
    public class MovementSlider : MonoBehaviour {
        ...
        private void OnTriggerEnter(Collider other) {
            ...
            if ((other.tag == "bingo") &&
                ...
                MySharedData.movementSliderPos = sliderSetting;

                _movementScript.moveSpeed = sliderSetting;
            }
        }
        ...
        bool SliderInRange() {
            ...
            return ((sliderSetting == MySharedData.movementSliderPos - 2) || (sliderSetting == MySharedData.movementSliderPos + 2)
                || (sliderSetting == MySharedData.movementSliderPos - 1) || (sliderSetting == MySharedData.movementSliderPos + 1));
        }
    }
}