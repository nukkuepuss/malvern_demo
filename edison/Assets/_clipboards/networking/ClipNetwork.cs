/// <summary>
/// ClipNetwork.cs
/// networking clipboard
/// button presses call functions in this script *** feature disabled in v3 due to PUN hands not re-instantiating after room disconnect/connect
/// </summary>
...
namespace com.jonrummery.edison {
    ...
    public class ClipNetwork : MonoBehaviourPunCallbacks {
        ...
        public GameObject punHandLeft, punHandRight;
        ...
        public Text headsetType;
        public Text tutorialStatus;
        ...
        private void Start() {
            ...
            headsetType.text = _headset.ToString();
        }
        ...
        public void JoinTrigger() {
            ...
            if ((PhotonNetwork.IsConnected) && (!PhotonNetwork.InRoom)) {
                ...
                // we're leaving the room, so our PUN hands will disappear. These will take their place.
                punHandLeft.SetActive(true);
                punHandRight.SetActive(true);
            }
        ...
        void UpdateText() {
            ...
            tutorialStatus.text = MySharedData.hasCompletedTutorial.ToString();
        }
        ...
        public void ConnectToRoom() {
            ...
            // joining a room will instantiate PUN hands, so get rif of our local hands
            //punHandLeft.SetActive(false);
            //punHandRight.SetActive(false);
        ...
        public override void OnJoinedRoom() {
            ...
            // joining a room will instantiate PUN hands, so get rid of our local hands
            //punHandLeft.SetActive(false);
            //punHandRight.SetActive(false);
