/// <summary>
/// RightArrowTrigger.cs
/// the right arrow trigger for the picture gallery
/// starts a method in another script when pressed
/// </summary>
...
namespace com.jonrummery.edison {
    ...
    public class RightArrowTrigger : MonoBehaviour {
        ...
        public GalleryManager handoverScript;
        ...
        private void OnTriggerEnter(Collider other) {
            ...
            if ((other.tag == "bingo") &&
                ...
                //do something
                handoverScript.RightArrowPress();
            }
        }
