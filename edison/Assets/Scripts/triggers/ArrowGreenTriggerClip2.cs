/// <summary>
/// Tutorial clipboard 2 ("You begin in the wicker basket of a hot air balloon") green arrow trigger
/// </summary>
...
namespace com.jonrummery.edison {
    ...
    public class ArrowGreenTriggerClip2 : MonoBehaviour {
        ...
        private void OnTriggerEnter(Collider other) {
            ...
            if ((other.tag == "bingo") &&
                ...
                //do something
                tutorialManager.Clip2GreenArrowTrigger();
            }
        }
