/// <summary>
/// Conference button trigger on the House clipboard
/// </summary>
...
namespace com.jonrummery.edison {
    ...
    public class ConferenceButtonTrigger : MonoBehaviour {

        [Header("Script with trigger action code")]
        public NewHouseSetup nextScript;
        ...
        private void OnTriggerEnter(Collider other) {
            ...
            if ((other.tag == "bingo") &&
                ...
                //do something
                nextScript.ConferenceTrigger(pos);
            }
        }
