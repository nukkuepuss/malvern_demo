/// <summary>
/// PlanetariumTrigger.cs
/// trigger an event in another script when the Planetarium button is pressed on the Conference Centre clipboard
/// </summary>
...
namespace com.jonrummery.edison {
    ...
    public class PlanetariumTrigger : MonoBehaviour {
        ...
        public ClipConferenceManager handoverScript;
        [Range(0, 1)]
        ...
        private void OnTriggerEnter(Collider other) {
            ...
            if ((other.tag == "bingo") &&
                ...
                //do something
                handoverScript.PlanetariumTrigger();
            }
        }
