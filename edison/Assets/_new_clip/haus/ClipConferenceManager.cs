/// <summary>
/// ClipConferenceManager.cs
/// handles the Conference centre clipboard buttons, actions and persistance
/// NB the Conference Centre model must be the last entry in the models array
/// </summary>
...
namespace com.jonrummery.edison {
    ...
    public class ClipConferenceManager : MonoBehaviour {
        ...
        private void OnEnable() {
            ...
            // NB last model is the Conference Centre itself
