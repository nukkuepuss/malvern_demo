/// <summary>
/// InnerWallsTrigger.cs
/// trigger an event in another script when the InnerWalls button is pressed on the Haus clipboard
/// </summary>
...
namespace com.jonrummery.edison {
    ...
    public class InnerWallsTrigger : MonoBehaviour {

        [Tooltip("Script with trigger action script")]
        public NewHouseManager handoverScript;
        [Range(0, 1)]
        ...
        private void OnTriggerEnter(Collider other) {
            ...
            if ((other.tag == "bingo") &&
                ...
                //do something
                handoverScript.InnerWallsTrigger();
            }
        }
